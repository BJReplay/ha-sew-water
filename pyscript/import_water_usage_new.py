...
def import_yesterdays_water_usage(
    ...
    Arguments:
        ...
        account_num: The South East Water Account Number. Example: 12345678
...
def import_water_usage(
    ...
    js_exec_path = f"{hass.config.config_dir}/pyscript/get_target_date_water_usage_new.js"  # noqa: F821
